...
export function PytestIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      <path
        fill="#696969"
        d="M31.512 30.398h61.304a3.006 3.006 0 0 1 0 6.012H31.512a3.007 3.007 0 0 1-3.004-3.004a3.008 3.008 0 0 1 3.004-3.008m0 0"
      ></path>
